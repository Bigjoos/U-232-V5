...
/* $Id: imdb_budget.class.php 691 2014-08-05 08:07:22Z izzy $ */
   ...
   default:
    ...
    public function budget()
    {
        if (empty($this->budget)) {
            if ($this->page["BoxOffice"] == "") {
                $this->openpage("BoxOffice");
            }
     ...
     * @see IMDB page / (TitlePage)
     */
    public function get_filmingDates($listFilmingDates)
    {
        $result = [];
