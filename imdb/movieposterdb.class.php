<?php
 ...
 /* $Id: movieposterdb.class.php 691 2014-08-05 08:07:22Z izzy $ */
...
#------------------------------------------------------------[ Constructor ]---
     ...
     */
    public function __construct($id, $limit=20, $recurse=true, mdb_config $config = null)
    {
        ...
        if ($this->force_agent) {
            $this->user_agent = $this->force_agent;
        } elseif (in_array('HTTP_USER_AGENT', array_keys($_SERVER))) {
