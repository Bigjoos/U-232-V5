...
$INSTALLER09['mysql_pass'] = '123qweasdzxc123';
...
$INSTALLER09['bot_username'] = 'Visitor';
$INSTALLER09['torrent_pass'] = '123qweasdzxc123';
$INSTALLER09['country'] = 'Afganistan';
...
//== XBT or PHP announce
if (XBT_TRACKER == true) {
$INSTALLER09['xbt_prefix'] = 'http://localhost/anounce.php:2710/';  
$INSTALLER09['xbt_suffix'] = '/announce';
$INSTALLER09['announce_urls'][] = 'http://localhost/anounce.php:2710/announce';
} else {
$INSTALLER09['announce_urls'] = array();
$INSTALLER09['announce_urls'][] = 'http://localhost/anounce.php';
$INSTALLER09['announce_urls'][] = 'https://localhost/anounce.php';
}
...
$INSTALLER09['site_email'] = 'test';
$INSTALLER09['site_name'] = "test";
