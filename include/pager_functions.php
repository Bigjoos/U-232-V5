    ...
    if ($count) {
        ...
        for ($i = 0; $i < $pages; $i++) {
            if (($i >= $dotspace && $i <= $curdotend) || ($i >= $curdotstart && $i < $dotend)) {
                if (!$dotted) {
                    $pagerarr[] = "<td  style=\"center\" class=\"pager\">...</td><td  style=\"center\" class=\"pagebr\">&nbsp;</td>";
                }
                $dotted = 1;
                continue;
            }
            ...
            $text = $i + 1;
            if ($i != $page) {
                $pagerarr[] = "<td  style=\"center\" class=\"pager\"><a title=\"$start&nbsp;-&nbsp;$end\" href=\"{$href}page=$i\" style=\"text-decoration: none;\"><b>$text</b></a></td><td  style=\"center\" class=\"pagebr\">&nbsp;</td>";
            } else {
                $pagerarr[] = "<td  style=\"center\" class=\"highlight\"><b>$text</b></td><td style=\"center\" class=\"pagebr\">&nbsp;</td>";
            }
        }
