...
$language_data = [
    ...
    'ESCAPE_CHAR' => '"',
    'KEYWORDS' => [
        1 => ['KEEP', 'FINISH', 'USE', 'SYSPROCS', 'IOSTATE', 'USING', 'ENVIRON'],
        2 => ['CASE', 'IN', 'OUSE', 'IN', 'OUT', 'ESAC', '(', '|', '|:', ')', 'FOR', 'FROM', 'TO', 'BY', 'WHILE', 'DO', 'OD', 'IF', 'THEN', 'ELIF', 'THEN', 'ELSE', 'FI', 'PAR', 'BEGIN', 'EXIT', 'END', 'GO', 'GOTO', 'FORALL', 'UPTO', 'DOWNTO', 'FOREACH', 'ASSERT'],
        3 => ['BITS', 'BOOL', 'BYTES', 'CHAR', 'COMPL', 'INT', 'REAL', 'SEMA', 'STRING', 'VOID', 'COMPLEX', 'VECTOR'],
        4 => ['MODE', 'OP', 'PRIO', 'PROC'],
        5 => ['FLEX', 'HEAP', 'LOC', 'LONG', 'REF', 'SHORT', 'EITHER'],
        6 => ['CHANNEL', 'FILE', 'FORMAT', 'STRUCT', 'UNION'],
        7 => ['OF', 'AT', '@', 'IS', ':=:', 'ISNT', ':/=:', ':≠:', 'CTB', 'CT', '::', 'CTAB', '::=', 'TRUE', 'FALSE', 'EMPTY', 'NIL', '○', 'SKIP', '~'],
