...
$htmlout .= "<form action='" . $this_url . "' method='post'>
    ...
    if ($edit_action) {
        $htmlout .= "
	<tr><td align='right' valign='top'>{$lang['forum_mngr_min']}</td><td align='left'>" . str_replace(['#name', 'value=\'' . htmlsafechars($a3['min_class_view']) . '\''], ['minclassview', 'value=\'' . htmlsafechars($a3['min_class_view']) . '\' selected=\'selected\''], $classes) . "</td></tr>";
    } else {
        $htmlout .= "
