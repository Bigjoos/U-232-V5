...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($subforum) || empty($descr) || empty($place)) {
        ...
        sql_query("INSERT INTO forums(`name`,`description` ,`min_class_read` ,`min_class_write` ,`min_class_create`,`place`,`forum_id`) VALUES(" . join(",", array_map("sqlesc", [$subforum, $descr, $readclass, $writeclass, $createclass, $place, $place])) . ")") or sqlerr(__FILE__, __LINE__);
