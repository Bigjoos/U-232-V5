...
if (mysqli_num_rows($res) == 0) {
    $HTMLOUT.= "" . $lang['staff_shistory_none'] . "";
} else {
    ...
    while ($arr = mysqli_fetch_assoc($res)) {
        ...
        if ($arr['to_user'] == $CURUSER['id'] || ($arr['userid'] == $CURUSER['id'] && $arr['to_user'] != 0)) {
            $private = "<img src='{$INSTALLER09['pic_base_url']}private-shout.png' alt='" . $lang['staff_shistory_private1'] . "' title='" . $lang['staff_shistory_private1'] . "!' width='16' style='padding-left:2px;padding-right:2px;' border='0' />";
        } else {
            $private = "<img src='{$INSTALLER09['pic_base_url']}group.png' alt='" . $lang['staff_shistory_public1'] . "' title='" . $lang['staff_shistory_public1'] . "!' width='16' style='padding-left:2px;padding-right:2px;' border='0' />";
        }
