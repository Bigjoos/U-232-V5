...
case 'process_edit':
    ...
    foreach (['forumname'=>1, 'forumdescr'=>1, 'overforum'=>1, 'minclassread'=>0, 'minclasswrite'=>0, 'minclasscreate'=>0, 'forumsort'=>0] as $key=>$empty_check) {
...
$htmlout .= "<form action='" . $this_url . "' method='post'>
    ...
    if ($edit_action) {
        $htmlout .= "
	<tr><td align='right' valign='top'>{$lang['fm_mp_min_r']}</td><td align='left'>" . str_replace(['#name', 'value=\'' . $a3['min_class_read'] . '\''], ['minclassread', 'value=\'' . htmlsafechars($a3['min_class_read']) . '\' selected=\'selected\''], $classes) . "</td></tr>
	<tr><td align='right' valign='top'>{$lang['fm_mp_min_w']}</td><td align='left'>" . str_replace(['#name', 'value=\'' . $a3['min_class_write'] . '\''], ['minclasswrite', 'value=\'' . htmlsafechars($a3['min_class_write']) . '\' selected=\'selected\''], $classes) . "</td></tr>
	<tr><td align='right' valign='top'>{$lang['fm_mp_min_c']}</td><td align='left'>" . str_replace(['#name', 'value=\'' . $a3['min_class_create'] . '\''], ['minclasscreate', 'value=\'' . htmlsafechars($a3['min_class_create']) . '\' selected=\'selected\''], $classes) . "</td></tr>";
    } else {
        $htmlout .= "
